...
const Works = () => {
  ...
  const text = `Featured projects that have been meticulously
    ...
    results and impact.`;
  const designText = `I create visually stunning designs that captivate and engage users.
From posters and branding to social media creatives and UI mockups,
    ...
    <section id="projects" className="flex flex-col min-h-screen">
      ...
      >
        ...
        <div className="mt-8 border-t border-black/20 pt-8">
          <AnimatedHeaderSection
            subTitle={"There is no limit to creativity"}
            title={"Designing"}
            text={designText}
            textColor={"text-black"}
            withScrollTrigger={true}
          />
          <p className="pb-10 text-center text-lg font-medium tracking-wide text-black/70 md:text-2xl">
            Coming soon
          </p>
